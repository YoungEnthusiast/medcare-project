...
urlpatterns = [
    ...
    #path('invoices/update/<int:id>', views.updateInvoice, name='invoice_update'),
    path('receptionist-dashboard/invoices/update/<int:pk>/', views.InvoiceUpdateView.as_view(), name='invoice_update'),
