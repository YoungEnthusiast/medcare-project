...
class Consultation(models.Model):
    ...
    injection_how = models.CharField(max_length=3, choices=HOW_CHOICES, default='1', null=True, blank=True, verbose_name="How Long? Day(s)")
    ...
    tablet_how = models.CharField(max_length=3, choices=HOW_CHOICES, default='1', null=True, blank=True, verbose_name="How Long? Day(s)")
    ...
    syrup_how = models.CharField(max_length=3, choices=HOW_CHOICES, default='1', null=True, blank=True, verbose_name="How Long? Day(s)")
